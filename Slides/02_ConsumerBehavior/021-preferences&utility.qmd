...
- It measures [how many units of $y$ would you give up to get one more unit of $x$?]{.hi}
...
- We can use another form of logic called [No-Waste Condition]{.hi}:
...
We say that preferences are always [complete]{.hi}. So when comparing bundles A and B, you can always say:
